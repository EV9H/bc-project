# Generated by Django 4.1.5 on 2023-07-10 06:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('word', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='base.word')),
            ],
        ),
        migrations.CreateModel(
            name='Entry',
            fields=[
                ...
                ('example', models.ManyToManyField(to='base.example')),
